        ...
        <div className="outer">
          <div className="inner">
            <div className="name">
              ...
              {nameValid ? (
                <p className="error">
                  * Name required and should contain alphabets
                </p>
              ) : (
                ""
              )}
            ...
            <div className="number">
              ...
              />
              {numberValid ? (
                <p className="error">* card number should contain 16 digits</p>
              ) : (
                ""
              )}
            </div>
            <div className="expcvv">
              <div className="exp">
                ...
                />
                {monthAndYearValid ? (
                  <p className="error"> *fill,month(1-12),year any</p>
                ) : (
                  ""
                )}
              </div>
              <div className="cvv">
                ...
                />
                {cvvValid ? (
                  <p className="error"> * cvv should be 3 digits</p>
                ) : (
                  ""
                )}
              </div>
